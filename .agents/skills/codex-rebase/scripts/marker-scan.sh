...
# codex-resolve-rebase-conflicts skill documents the marker shape by showing
...
exempt() {
  ...
  */skills/resolve-rebase-conflicts/SKILL.md | skills/resolve-rebase-conflicts/SKILL.md | \
    */skills/codex-resolve-rebase-conflicts/SKILL.md | skills/codex-resolve-rebase-conflicts/SKILL.md)
    return 0
    ;;
  esac
